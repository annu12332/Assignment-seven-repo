...
const AvailableTickets = ({ tickets }) => {
    ...
    return (
        ...
        <div>
                    ...
                    >
                        ...
                        <div className="card-body p-1.5 ">
                            <div className="flex justify-between items-center">
                                <h2 className="card-title text-xs font-semibold text-gray-700">{ticket.title}</h2>
                                <h3>Open</h3>
                            </div>
                            ...
                            <div className="flex justify-between">
                                <div className="flex gap-1" >
                                    ...
                                    <p className= {`priority-${ticket.priority.toLowerCase()} font-semibold text-xs`}>{ticket.priority} priority</p>
                                </div>
           ...
           <div>
            <div>
            <h2 className="mt-[-35px] text-gray-800 text-sm font-bold mb-2">Task Status</h2>
             <div className="text-gray-800 bg-white  rounded-md p-2">
                <h1 className="text-sm font-semibold"></h1>
                <p className="text-xs whitespace-nowrap">Select a ticket to add to Task Status</p>
            </div>
           </div>

           <div>
            <h2 className="mt-[-px] text-gray-800 text-sm font-bold mb-2">Task Status</h2>
             <div className="text-gray-800 bg-white  rounded-md p-2">
                <h1 className="text-sm font-semibold"></h1>
                <p className="text-xs whitespace-nowrap">Select a ticket to add to Task Status</p>
            </div>
